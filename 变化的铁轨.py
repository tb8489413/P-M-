...
def h_j():
    ...
    mc.setBlocks(x1,0,z1,x1,4,z2,152)
    mc.setBlocks(x1,5,z1,x1,5,z2,79)
def h_x():
    x3 = random.randint(0,100)
    z3 = random.randint(0,100)
    z4 = random.randint(0,100)
    mc.setBlocks(x3,0,z3,x3,5,z4,0)

def s_j():
    x5 = random.randint(0,100)
    x6 = random.randint(0,100)
    z5 = random.randint(0,100)      
    mc.setBlocks(x5,0,z5,x6,4,z5,152)
    mc.setBlocks(x5,5,z5,x6,5,z5,79)
    
def s_x():
    x5 = random.randint(0,100)
    x6 = random.randint(0,100)
    z5 = random.randint(0,100)
    mc.setBlocks(x5,0,z5,x6,5,z5,0)
